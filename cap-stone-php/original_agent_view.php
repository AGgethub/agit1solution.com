...
<body>
    ...
    <div class="container-fluid " style="background-color:#deebea;">
...
<!---------------------------LOGIN LOG OUT BUTTON--------------------------------------->
    <!-- BUTTON AND LOGOUT LINKS GOOD -->
        ...
        <div class=" col  mt-3  ">
            <a href="index.php" class=" float-end mx-3"><h5>Log out</h5></a>
        </div>
...
<!---------------------------LOGIN LOG OUT BUTTON--------------------------------------->
        ...
        <!----- AG agent_customer_details.php will feed below------>
        <section class="row">
            
        <article class="col-lg ">
                <div class= "card m-1 p-2    " >
                    
                    <h4 class="service_heading_h4"> AGENT CLIENT  LISTING </h4>

                            <!-- TEST TABLE HEADING ROW -->
                            <!-- Start PHP Test row 1 information feed from agent_customer_details.php -->
                            <?php
                                include "or_link_agent_view_customer.php";
                            ?>
                            <!-- Start PHP Test row 1 information feed from agent_customer_details.php -->
        ...
        <!-- THIS section div ADDS A PLACE HOLDER ABOVE OUR FORM FOR SPACING START-->
        <section class="row">
            <div class="spacing_box " style="height: 300px; width:100%;"></div>
        </section>

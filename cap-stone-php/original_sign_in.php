  ...
  <div class="container signUpForm info  ">
    ...
    <!-- SECTION1 SIGN IN FORM STARTS-->
      <section class= "row mx-2    form_section mt-5 mb-3 card  ">  <!--col-md-6 offset-md-3-->
        ...
        <h3 class=" sub_headings">Sign in to schedule service appointment</h3>

        <div class="  form_box  ">
            <form action="original_customer_view.php" class="   pd-2 m-6 p-5  form_size   " > <!--Need to add link action-->
